    ...
    <VStack gap={6} align="stretch">
      ...
      <Box p={4} borderWidth="1px" borderRadius="md">
        ...
        <Box
          ...
          borderRadius="md"
          _hover={{ bg: "blue.600" }}
          onClick={() => document.getElementById(validateInputId)?.click()}
          opacity={isValidateLoading ? 0.7 : 1}
        >
          {isValidateLoading
            ? "Validating..."
            : "Select Backup File to Validate"}
        </Box>
      ...
      <Box p={4} borderWidth="1px" borderColor="red.300" borderRadius="md">
        ...
        <Box
          ...
          borderRadius="md"
          _hover={{ bg: "red.600" }}
          onClick={() => document.getElementById(restoreInputId)?.click()}
          opacity={isRestoreLoading ? 0.7 : 1}
        >
          {isRestoreLoading ? "Restoring..." : "Select Backup File to Restore"}
        </Box>
      ...
      {showRestoreConfirm && pendingRestoreFile && (
        <Box p={6} borderWidth="2px" borderColor="red.400" borderRadius="md" bg="red.50">
          <VStack gap={4} align="stretch">
            ...
            <Text fontSize="sm" color="red.700" fontWeight="bold">
              This will replace ALL current data with the backup contents. This
