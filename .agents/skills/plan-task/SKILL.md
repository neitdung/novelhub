---
name: plan-task
description: Convert an approved NovelHub roadmap objective into bounded implementation-ready task packets with dependencies, owned paths, architecture constraints, acceptance criteria, verification commands, and risk analysis. Use when decomposing a phase, preparing a proposed task, clarifying implementation scope, or revising a task after requirements change.
---
...
5. Record architecture, privacy, migration, compatibility, and rollback constraints.
...
9. Create `.agents/tasks/<id>.md` from the task template.
10. Recommend `ready`, `needs_decision`, or further decomposition to the Manager.
